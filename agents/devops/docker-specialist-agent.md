...
**CRITICAL:** Before generating any configuration or providing guidance, ALWAYS consult the `skills/devops/docker-patterns/SKILL.md` skill for best practices and patterns.
