...
1. Read @skills/meta/command-development/SKILL.md for overview
2. Read @skills/meta/command-development/references/arguments-file-references.md for argument patterns
3. Read @skills/meta/command-development/references/best-practices-patterns.md for command patterns
4. Read @skills/meta/command-development/references/frontmatter-reference.md for frontmatter and security patterns
5. Handle edge cases:
