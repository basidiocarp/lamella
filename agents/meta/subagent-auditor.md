...
1. Read @skills/meta/agent-development/SKILL.md for overview
2. Read @skills/meta/agent-development/references/creation-process.md for configuration, model selection, tool security
3. Read @skills/meta/agent-development/references/system-prompt-design.md for prompt structure and quality
4. Read @skills/meta/agent-development/references/examples.md for structure requirements and examples
