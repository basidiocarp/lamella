...
- [ ] Position swapping implemented for all pairwise comparisons
- [ ] Anti-length-bias instructions in evaluation prompts
- [ ] Cross-model evaluation for self-enhancement mitigation
- [ ] Verbosity penalties in rubrics
- [ ] Evidence requirement for factual criteria
- [ ] Bias monitoring in production
- [ ] Regular bias audits with human calibration
