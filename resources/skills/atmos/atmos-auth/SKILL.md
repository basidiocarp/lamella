...
- [Identity Types](#identity-types)
  ...
  - [AWS Assume Root](#aws-assume-root)
  - [AWS User (Break-glass)](#aws-user-break-glass)
  - [Azure Subscription](#azure-subscription)
  - [GCP Service Account](#gcp-service-account)
  - [GCP Project](#gcp-project)
- [Identity Chaining](#identity-chaining)
...
- [CI/CD Integration](#cicd-integration)
  - [GitHub Actions with OIDC](#github-actions-with-oidc)
  - [Disabling Auth in CI](#disabling-auth-in-ci)
- [Profiles for Environment Switching](#profiles-for-environment-switching)
- [ECR Integrations](#ecr-integrations)
