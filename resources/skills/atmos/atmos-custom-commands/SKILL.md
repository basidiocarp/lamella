...
description: "Custom CLI commands: command definition in atmos.yaml, arguments, flags, steps, env vars. Use when defining custom Atmos CLI commands, adding arguments/flags, or automating multi-step operations."
metadata:
  version: "1.0.0"
---
