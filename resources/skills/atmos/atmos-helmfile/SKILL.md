...
- [How Atmos Orchestrates Helmfile](#how-atmos-orchestrates-helmfile)
- [Stack Configuration for Helmfile Components](#stack-configuration-for-helmfile-components)
...
- [Core Commands](#core-commands)
  ...
  - [destroy](#destroy)
  - [deploy](#deploy)
- [Variable File Generation](#variable-file-generation)
- [Source Management (JIT Vendoring)](#source-management-jit-vendoring)
...
- [EKS Integration](#eks-integration)
  ...
  - [Cluster Name Precedence](#cluster-name-precedence)
  - [Non-EKS Kubernetes Clusters](#non-eks-kubernetes-clusters)
...
- [Debugging](#debugging)
  ...
  - [Dry Run](#dry-run)
  - [Helm Debug Logging](#helm-debug-logging)
...
A single `atmos helmfile apply nginx-ingress -s ue2-dev` handles kubeconfig, variable files, and helmfile execution.
...
```shell
cd components/helmfile/echo-server && atmos helmfile diff . -s dev
atmos helmfile apply components/helmfile/echo-server -s dev
```

Path resolution requires the path to resolve to a single unique component in the stack.
