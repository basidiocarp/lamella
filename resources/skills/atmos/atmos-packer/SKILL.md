---
name: atmos-packer
description: "Packer orchestration: init/build/validate/inspect/output, machine image building, template management, source management. Use when building machine images with Atmos/Packer, validating templates, or managing image sources across environments."
metadata:
  version: "1.0.0"
---
...
- [How Atmos Orchestrates Packer](#how-atmos-orchestrates-packer)
...
- [Template Management](#template-management)
  - [Directory Mode (Default)](#directory-mode-default)
  - [Single File Mode](#single-file-mode)
  - [Template Configuration in Stack Manifests](#template-configuration-in-stack-manifests)
- [Source Management and JIT Vendoring](#source-management-and-jit-vendoring)
  - [Source Configuration](#source-configuration)
  - [Source Fields](#source-fields)
  - [Automatic Provisioning](#automatic-provisioning)
  - [Source Commands](#source-commands)
  - [Version Pinning per Environment](#version-pinning-per-environment)
  - [Supported Source Protocols](#supported-source-protocols)
  - [Authentication for Sources](#authentication-for-sources)
- [Path-Based Component Resolution](#path-based-component-resolution)
- [Common Flags](#common-flags)
- [Manifest Parsing with YQ](#manifest-parsing-with-yq)
- [Debugging](#debugging)
...
A single `atmos packer build ubuntu-base -s ue2-dev` handles variable files, path config, and packer execution.
...
Use filesystem paths instead of component names:

```shell
cd components/packer/aws/bastion && atmos packer validate . -s prod
atmos packer build components/packer/aws/bastion -s prod
```

Supported formats: `.`, `./component`, `../sibling`, `/absolute/path`. Path must resolve to a single unique component.
