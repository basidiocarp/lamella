...
- [Configuring Stores in atmos.yaml](#configuring-stores-in-atmosyaml)
  - [Store Naming Convention](#store-naming-convention)
  - [Common Options (All Providers)](#common-options-all-providers)
  - [Identity-Based Authentication](#identity-based-authentication)
- [Store Provider Configuration](#store-provider-configuration)
  - [AWS SSM Parameter Store](#aws-ssm-parameter-store)
  - [Azure Key Vault](#azure-key-vault)
  - [Google Secret Manager](#google-secret-manager)
  - [Redis](#redis)
  - [Artifactory](#artifactory)
- [Reading from Stores with YAML Functions](#reading-from-stores-with-yaml-functions)
  - [`!store` -- Component-Aware Access](#store----component-aware-access)
  - [`!store.get` -- Arbitrary Key Access](#storeget----arbitrary-key-access)
  - [`atmos.Store` -- Go Template Access](#atmosstore----go-template-access)
- [Writing to Stores with Hooks](#writing-to-stores-with-hooks)
  - [DRY Hook Configuration (Layered)](#dry-hook-configuration-layered)
- [Cross-Account and Cross-Region Access](#cross-account-and-cross-region-access)
  - [AWS Cross-Account via Role Assumption](#aws-cross-account-via-role-assumption)
  - [Multi-Region Configuration](#multi-region-configuration)
- [End-to-End Example: VPC to EKS](#end-to-end-example-vpc-to-eks)
