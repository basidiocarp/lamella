...
- [Workflow File Location and Discovery](#workflow-file-location-and-discovery)
  - [Configuration](#configuration)
  - [Directory Structure](#directory-structure)
  - [Auto-Discovery](#auto-discovery)
- [Workflow YAML Syntax](#workflow-yaml-syntax)
  - [Basic Structure](#basic-structure)
  - [Step Types](#step-types)
  - [Retry Configuration](#retry-configuration)
  - [Working Directory](#working-directory)
  - [Workflow Dependencies](#workflow-dependencies)
- [Working with Stacks in Workflows](#working-with-stacks-in-workflows)
  - [1. Inline in the Command](#1-inline-in-the-command)
  - [2. Workflow-Level Stack](#2-workflow-level-stack)
  - [3. Step-Level Stack](#3-step-level-stack)
  - [4. Command-Line Stack (Highest Priority)](#4-command-line-stack-highest-priority)
- [Executing Workflows](#executing-workflows)
  - [Basic Execution](#basic-execution)
  - [Interactive Mode](#interactive-mode)
  - [Starting from a Specific Step](#starting-from-a-specific-step)
  - [Failure Handling](#failure-handling)
- [Using Authentication with Workflows](#using-authentication-with-workflows)
  - [Per-Step Identity](#per-step-identity)
  - [Default Identity via Flag](#default-identity-via-flag)
  - [Mixed Authentication](#mixed-authentication)
- [Common Workflow Patterns](#common-workflow-patterns)
  - [Deploy All Components in Order](#deploy-all-components-in-order)
  - [Mixed Atmos and Shell Commands](#mixed-atmos-and-shell-commands)
  - [Nesting Workflows](#nesting-workflows)
- [atmos workflow Command Reference](#atmos-workflow-command-reference)
  - [Syntax](#syntax)
  - [Arguments](#arguments)
  - [Flags](#flags)
...
Use Atmos Custom Commands in workflows, and workflows in Custom Commands -- they are
fully interoperable.
...
For additional patterns (nesting workflows, multi-env deploy, teardown, validation pipelines),
...
8. **Use `--from-step` for recovery.** When a workflow fails, fix the issue and resume from the
