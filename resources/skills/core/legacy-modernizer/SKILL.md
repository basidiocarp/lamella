...
description: Incremental legacy system migration using strangler fig, branch by abstraction, and zero-downtime modernization strategies. Use when modernizing legacy systems, implementing incremental migration, or reducing technical debt.
---
