...
description: Implements GitOps workflows with ArgoCD and Flux for automated, declarative Kubernetes deployments with continuous reconciliation. Use when implementing GitOps practices, automating Kubernetes deployments, or setting up declarative infrastructure management.
---
...
- [OpenGitOps Principles](#opengitops-principles)
- [ArgoCD Setup](#argocd-setup)
  - [1. Installation](#1-installation)
  - [2. Repository Structure](#2-repository-structure)
  - [3. Create Application](#3-create-application)
  - [4. App of Apps Pattern](#4-app-of-apps-pattern)
- [Flux CD Setup](#flux-cd-setup)
  - [1. Installation](#1-installation)
  - [2. Create GitRepository](#2-create-gitrepository)
  - [3. Create Kustomization](#3-create-kustomization)
- [Sync Policies](#sync-policies)
  - [Auto-Sync Configuration](#auto-sync-configuration)
- [Progressive Delivery](#progressive-delivery)
  - [Canary Deployment with ArgoCD Rollouts](#canary-deployment-with-argocd-rollouts)
