...
- [Core Capabilities](#core-capabilities)
  - [1. Define Container Images](#1-define-container-images)
  - [2. Create Functions](#2-create-functions)
  - [3. Request GPUs](#3-request-gpus)
  - [4. Configure Resources](#4-configure-resources)
  - [5. Scale Automatically](#5-scale-automatically)
  - [6. Store Data Persistently](#6-store-data-persistently)
  - [7. Manage Secrets](#7-manage-secrets)
  - [8. Deploy Web Endpoints](#8-deploy-web-endpoints)
  - [9. Schedule Jobs](#9-schedule-jobs)
- [Common Workflows](#common-workflows)
  - [Deploy ML Model for Inference](#deploy-ml-model-for-inference)
  - [Batch Process Large Dataset](#batch-process-large-dataset)
  - [Train Model on GPU](#train-model-on-gpu)
