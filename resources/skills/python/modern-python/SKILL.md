...
- [Quick Start: Minimal Project](#quick-start-minimal-project)
- [Full Project Setup](#full-project-setup)
  - [1. Create Project Structure](#1-create-project-structure)
  - [2. Configure pyproject.toml](#2-configure-pyprojecttoml)
  - [3. Install Dependencies](#3-install-dependencies)
  - [4. Add Makefile](#4-add-makefile)
- [Migration Guide](#migration-guide)
  - [From requirements.txt + pip](#from-requirementstxt-pip)
  - [From setup.py / setup.cfg](#from-setuppy-setupcfg)
  - [From flake8 + black + isort](#from-flake8-black-isort)
  - [From mypy / pyright](#from-mypy-pyright)
- [Quick Reference: uv Commands](#quick-reference-uv-commands)
  - [Ad-hoc Dependencies with `--with`](#ad-hoc-dependencies-with---with)
- [Quick Reference: Dependency Groups](#quick-reference-dependency-groups)
...
- [Dependabot](assets/dependabot.yml)
- [Pre Commit Config](assets/pre-commit-config.yaml)
