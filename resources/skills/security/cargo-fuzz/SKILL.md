...
name: cargo-fuzz
description: >-
  cargo-fuzz is the de facto fuzzing tool for Rust projects using Cargo. Use when fuzzing Rust code with libFuzzer backend.
metadata:
  type: fuzzer
---
# cargo-fuzz
...
- [Running Campaigns](#running-campaigns)
  - [Basic Run](#basic-run)
  - [Without Sanitizers (Safe Rust)](#without-sanitizers-safe-rust)
...
- [Sanitizer Integration](#sanitizer-integration)
  ...
  - [Disabling Sanitizers](#disabling-sanitizers)
  - [Checking for Unsafe Code](#checking-for-unsafe-code)
- [Coverage Analysis](#coverage-analysis)
  - [Prerequisites](#prerequisites)
  - [Generating Coverage Reports](#generating-coverage-reports)
- [Advanced Usage](#advanced-usage)
  - [Tips and Tricks](#tips-and-tricks)
  - [libFuzzer Options](#libfuzzer-options)
  - [Multi-Core Fuzzing](#multi-core-fuzzing)
- [Real-World Examples](#real-world-examples)
  - [Example: ogg Crate](#example-ogg-crate)
- [Troubleshooting](#troubleshooting)
- [Related Skills](#related-skills)
  - [Technique Skills](#technique-skills)
  - [Related Fuzzers](#related-fuzzers)
- [Resources](#resources)
...
> see the **fuzz-coverage-analysis** technique skill.
...
| **fuzz-coverage-analysis** | Measuring and improving fuzzing effectiveness |
