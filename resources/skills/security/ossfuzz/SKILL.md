...
- [OSS-Fuzz Project Components](#oss-fuzz-project-components)
  - [Bug Tracker](#bug-tracker)
  - [Build Status System](#build-status-system)
  - [Fuzz Introspector](#fuzz-introspector)
- [Step-by-Step: Running a Single Harness](#step-by-step-running-a-single-harness)
  - [Step 1: Clone OSS-Fuzz](#step-1-clone-oss-fuzz)
  - [Step 2: Build Project Image](#step-2-build-project-image)
  - [Step 3: Build Fuzzers with Sanitizers](#step-3-build-fuzzers-with-sanitizers)
  - [Step 4: Run the Fuzzer](#step-4-run-the-fuzzer)
  - [Step 5: Coverage Analysis (Optional)](#step-5-coverage-analysis-optional)
- [Common Patterns](#common-patterns)
  - [Pattern: Running irssi Example](#pattern-running-irssi-example)
  - [Pattern: Enrolling a New Project](#pattern-enrolling-a-new-project)
- [Docker Images in OSS-Fuzz](#docker-images-in-oss-fuzz)
  - [Image Hierarchy](#image-hierarchy)
  - [Runner Images (Used Separately)](#runner-images-used-separately)
...
Since OSS-Fuzz is open-source, host your own instance for:
...
| Skill | Relationship |
|-------|--------------|
| **fuzz-coverage-analysis** | OSS-Fuzz generates coverage reports via helper.py |
