...
- Creating custom Semgrep rules → See Custom Rule Creation references below
...
### Custom Rule Creation (absorbed from semgrep-rule-creator)
| File | Description |
|------|-------------|
| [references/rule-creator-workflow.md](references/rule-creator-workflow.md) | Rule creation workflow |
| [references/rule-creator-quick-reference.md](references/rule-creator-quick-reference.md) | Quick reference card |
| [references/rule-creator-applicability-analysis.md](references/rule-creator-applicability-analysis.md) | Cross-language applicability |
| [references/rule-creator-language-syntax-guide.md](references/rule-creator-language-syntax-guide.md) | Language syntax guide |
| [references/rule-creator-variant-workflow.md](references/rule-creator-variant-workflow.md) | Variant porting workflow |
