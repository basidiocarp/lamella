...
1. gather commits, PRs, and issue references
2. structure the technical changelog
3. identify the few changes users will actually care about
4. rewrite them in user-benefit language
