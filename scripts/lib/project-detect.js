...
const FRAMEWORK_RULES = [
  ...
  // Go frameworks
  {
    ...
    language: "golang",
    markers: [],
    packageKeys: ["github.com/gin-gonic/gin"],
  },
  {
    framework: "echo",
    language: "golang",
    markers: [],
    packageKeys: ["github.com/labstack/echo"],
  },
...
function detectProjectType(projectDir) {
  ...
  for (const rule of LANGUAGE_RULES) {
    ...
    const hasExt =
      ...
      hasFileWithExtension(projectDir, rule.extensions);
