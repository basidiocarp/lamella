...
- [What Components Are](#what-components-are)
- [Component Types](#component-types)
- [Directory Structure](#directory-structure)
- [Component Configuration in Stacks](#component-configuration-in-stacks)
- [Abstract vs Real Components](#abstract-vs-real-components)
  - [Abstract Components](#abstract-components)
  - [Real Components (Default)](#real-components-default)
...
- [metadata Section Fields](#metadata-section-fields)
- [Catalog Patterns](#catalog-patterns)
- [Mixins for Reusable Configuration](#mixins-for-reusable-configuration)
- [Remote State Access Between Components](#remote-state-access-between-components)
- [Component Versioning Patterns](#component-versioning-patterns)
...
Multiple inheritance composes "traits": reusable abstract components representing independent concerns (logging, security, sizing, environment settings).
...
The `stacks/catalog/` directory holds reusable component configurations as abstract components with sensible defaults. Top-level stacks import from the catalog and override only what differs.

For catalog organization patterns, mixin patterns, and component archetypes, see the `atmos-design-patterns` skill.

## Mixins for Reusable Configuration

Mixins are small, focused configuration snippets stored in `stacks/mixins/` that alter component behavior (regions, stages, tenants). Import them into stacks to compose configurations. See the `atmos-design-patterns` skill for mixin patterns and examples.
...
Atmos supports folder-based versioning (multiple versions side by side via `metadata.component`) and vendor-based versioning (`atmos vendor pull` to pin upstream versions). For version management strategies, see the `atmos-design-patterns` skill. For vendoring details, see the `atmos-vendoring` skill.
