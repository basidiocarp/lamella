...
The `metadata.component` field specifies which Terraform root module the Atmos component maps to. The Atmos component name can differ from the Terraform module directory name:
