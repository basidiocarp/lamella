...
> This skill creates personalized tutorials using real code from current projects, building on demonstrated knowledge, and tracking progress over time.
>
...
If no tutorials exist in `~/coding-tutor-tutorials/` AND no learner profile exists at `~/coding-tutor-tutorials/learner_profile.md`, this is a brand new learner. Before teaching anything, understand who you're teaching.
...
- **Survey existing knowledge**: Run `python3 scripts/index_tutorials.py` to understand what concepts have been covered, at what depth, and how well they landed (understanding scores). Optionally, dive into particular tutorials in `~/coding-tutor-tutorials/` to read them.
...
```bash
python3 scripts/create_tutorial.py "Topic Name" --concepts "Concept1,Concept2"
```

This creates an empty template of the tutorial. Then edit the newly created file to write in the actual tutorial.
...
Tutorials should be engaging and story-driven, inspired by Julia Evans and Dan Abramov's teaching style.

Note: If you're not sure about a fact or capability or new features/APIs, do web research, look at documentation to you're teaching accurate up-to-date things. NEVER commit the sin of teaching something incorrect.

## The Living Tutorial

Tutorials aren't static documents - they evolve:

- **Q&A is mandatory**: When the learner asks ANY clarifying question about a tutorial, append it to the tutorial's `## Q&A` section. This is not optional - these exchanges are part of their personalized learning record and improve future teaching.
...
- Open: "Quiz me on something" → run `python3 scripts/quiz_priority.py` to get a prioritized list based on spaced repetition, then choose what to quiz
...
The script uses Fibonacci-ish intervals: score 1 = review in 2 days, score 5 = 13 days, score 8 = 55 days, score 10 = 144 days. Weak concepts get drilled frequently while mastered ones fade into long-term review.
...
- [Setup: Ensure Tutorials Repo Exists](#setup-ensure-tutorials-repo-exists)
- [First Step: Know Your Learner](#first-step-know-your-learner)
- [Teaching Philosophy](#teaching-philosophy)
- [Tutorial Creation](#tutorial-creation)
- [Q&A](#qa)
- [Quiz History](#quiz-history)
  - [Tutorial Writing Style](#tutorial-writing-style)
- [The Living Tutorial](#the-living-tutorial)
- [What Makes Great Teaching](#what-makes-great-teaching)
- [Quiz Mode](#quiz-mode)
  - [Quiz - DD-MM-YYYY](#quiz---dd-mm-yyyy)
