...
- [Pod Security Standards](#pod-security-standards)
  - [1. Privileged (Unrestricted)](#1-privileged-unrestricted)
  - [2. Baseline (Minimally restrictive)](#2-baseline-minimally-restrictive)
  - [3. Restricted (Most restrictive)](#3-restricted-most-restrictive)
- [Network Policies](#network-policies)
  - [Default Deny All](#default-deny-all)
  - [Allow Frontend to Backend](#allow-frontend-to-backend)
  - [Allow DNS](#allow-dns)
- [RBAC Configuration](#rbac-configuration)
  - [Role (Namespace-scoped)](#role-namespace-scoped)
  - [ClusterRole (Cluster-wide)](#clusterrole-cluster-wide)
  - [RoleBinding](#rolebinding)
- [Pod Security Context](#pod-security-context)
  - [Restricted Pod](#restricted-pod)
- [Policy Enforcement with OPA Gatekeeper](#policy-enforcement-with-opa-gatekeeper)
  - [ConstraintTemplate](#constrainttemplate)
  - [Constraint](#constraint)
- [Service Mesh Security (Istio)](#service-mesh-security-istio)
