...
mbake is a modern Python-based tool designed to format and validate Makefiles with intelligent features. It is the first comprehensive Makefile formatter and linter, filling a 50-year gap in build tooling.
