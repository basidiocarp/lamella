---
name: promql
description: Generate, validate, lint, and optimize PromQL queries, alerting rules, and recording rules. Use when writing PromQL, creating alerting rules, validating syntax, detecting anti-patterns, or optimizing expressions.
---
