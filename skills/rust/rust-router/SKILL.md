---
name: rust-router
description: Rust development including errors, design, and coding. Handles compile errors (ownership, borrowing, lifetimes), async/await, error handling, and crate selection. Use when encountering Rust compile errors, debugging ownership/borrowing/lifetime issues, implementing async code, or selecting crates.
metadata:
  globs:
  - '**/Cargo.toml'
  - '**/*.rs'
...
- [Meta-Cognition Framework](#meta-cognition-framework)
  - [Core Principle](#core-principle)
  - [Routing by Entry Point](#routing-by-entry-point)
  - [CRITICAL: Dual-Skill Loading](#critical-dual-skill-loading)
- [INSTRUCTIONS FOR CLAUDE](#instructions-for-claude)
  - [CRITICAL: Negotiation Protocol Trigger](#critical-negotiation-protocol-trigger)
- [Negotiation Analysis](#negotiation-analysis)
  - [Source: [Agent/Skill Name]](#source-agentskill-name)
- [Synthesized Answer](#synthesized-answer)
  - [Default Project Settings](#default-project-settings)
- [Layer 1 Skills (Language Mechanics)](#layer-1-skills-language-mechanics)
- [Layer 2 Skills (Design Choices)](#layer-2-skills-design-choices)
- [Layer 3 Skills (Domain Constraints)](#layer-3-skills-domain-constraints)
...
> Context optimized - detailed examples moved to sub-files
