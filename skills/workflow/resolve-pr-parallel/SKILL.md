...
description: "Resolve all PR comments using parallel processing. Use when addressing PR review feedback, resolving review\
  \ threads, or batch-fixing PR comments."
metadata:
